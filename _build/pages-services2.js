...
const installPages = [
  ...
  servicePage({ file:'services/garage-door-installation/commercial.html', title:'Commercial Garage Doors San Diego | Castle', description:'Commercial garage door installation & repair in San Diego. Sectional, rolling, high-speed doors. Call (800) 576-1397.', h1:'Commercial Garage Doors', subtitle:'Durable, secure, and efficient doors for your business.', crumbs:instCrumbs('Commercial'),
...
const openerPages = [
  ...
  servicePage({ file:'services/garage-door-openers/repair.html', title:'Garage Door Opener Repair San Diego | Castle', description:'Garage door opener repair in San Diego. Motor, gear, remote, circuit board repair. All brands. Call (800) 576-1397.', h1:'Garage Door Opener Repair', subtitle:'Before you replace your opener, let us see if a repair can save you money.', crumbs:opCrumbs('Repair'),
  ...
  servicePage({ file:'services/garage-door-openers/smart-wifi.html', title:'Smart WiFi Garage Door Openers San Diego | Castle', description:'Smart WiFi garage door openers in San Diego. Control from your phone. LiftMaster myQ. Professional installation. Call (800) 576-1397.', h1:'Smart / WiFi-Enabled Garage Door Openers', subtitle:'Open, close, and monitor your garage door from anywhere.', crumbs:opCrumbs('Smart / WiFi'),
...
const gatePages = [
  ...
  servicePage({ file:'services/gate-services/repair.html', title:'Gate Repair San Diego | Castle', description:'Gate repair in San Diego. Electric gate, sliding gate, swing gate repair. Motor, hinge, track issues. Call (800) 576-1397.', h1:'Gate Repair', subtitle:'Expert repair for all types of residential and commercial gates.', crumbs:gateCrumbs('Repair'),
  ...
  servicePage({ file:'services/gate-services/driveway.html', title:'Driveway Gates San Diego | Castle', description:'Driveway gate installation in San Diego. Sliding, swing, wrought iron, wood. Enhance security & curb appeal. Call (800) 576-1397.', h1:'Driveway Gates', subtitle:'The first impression your property makes — make it count.', crumbs:gateCrumbs('Driveway Gates'),
  ...
  servicePage({ file:'services/gate-services/openers.html', title:'Gate Openers San Diego | Castle', description:'Gate opener installation and repair in San Diego. Swing, slide, and barrier operators. All brands. Call (800) 576-1397.', h1:'Gate Openers', subtitle:'Reliable gate operator systems installed and serviced by experts.', crumbs:gateCrumbs('Gate Openers'),
