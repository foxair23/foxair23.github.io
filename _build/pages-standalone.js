...
function blogIndex() {
  ...
  const posts = [
    {slug:'loud-garage-door-noises', title:'Why Is My Garage Door So Loud?', excerpt:'Grinding, squeaking, rattling, or banging — identify the noise and fix the problem.', tag:'Troubleshooting', date:'April 2026', img:'https://images.unsplash.com/photo-1558618666-fcd25c85f82e?w=400&q=70', alt:'Garage door rollers and track hardware close-up'},
    {slug:'garage-door-wont-open', title:'Garage Door Won\'t Open? Step-by-Step Fix', excerpt:'Systematic troubleshooting when your garage door refuses to open.', tag:'Troubleshooting', date:'April 2026', img:'https://images.unsplash.com/photo-1600585154340-be6161a56a0c?w=400&q=70', alt:'Closed garage door on a residential home'},
    {slug:'springs-most-dangerous-part', title:'Springs: The Most Dangerous Part of the Industry', excerpt:'Why garage door springs demand professional handling — not a DIY project.', tag:'Safety', date:'March 2026', img:'https://images.unsplash.com/photo-1621905252507-b35492cc74b4?w=400&q=70', alt:'Torsion spring mounted on a steel shaft above a garage door opening'},
    {slug:'signs-garage-door-spring-broken', title:'How to Know If Your Garage Door Spring Is Broken', excerpt:'Learn the telltale signs of a broken or failing garage door spring, and what to do next.', tag:'Repair', date:'March 2026', img:'https://images.unsplash.com/photo-1504328345606-18bbc8c9d7d1?w=400&q=70', alt:'Close-up of a broken garage door torsion spring with visible gap'},
    {slug:'when-garage-door-unsafe-to-repair', title:'When a Garage Door Becomes Unsafe to Repair', excerpt:'Safety and economic thresholds that mean it\'s time to replace, not repair.', tag:'Safety', date:'March 2026', img:'https://images.unsplash.com/photo-1600596542815-ffad4c1539a9?w=400&q=70', alt:'Old weathered garage door showing signs of age and wear'},
    {slug:'warranty-compliance-policy', title:'Warranty & Compliance: What Castle Covers', excerpt:'CSLB licensing, parts warranties, labor guarantees, and safety standards.', tag:'Policy', date:'February 2026', img:'https://images.unsplash.com/photo-1486406146926-c627a92ad1ab?w=400&q=70', alt:'Castle Garage Doors service truck with branding'},
    {slug:'garage-door-wont-close', title:'Garage Door Won\'t Close? Here\'s What to Check', excerpt:'Troubleshooting steps when your garage door refuses to close all the way.', tag:'Troubleshooting', date:'February 2026', img:'https://images.unsplash.com/photo-1581578731548-c64695cc6952?w=400&q=70', alt:'Garage door safety sensor at bottom of track'},
    {slug:'new-garage-door-cost-san-diego', title:'How Much Does a New Garage Door Cost in San Diego?', excerpt:'A realistic breakdown of garage door costs for San Diego homeowners in 2026.', tag:'Installation', date:'March 2026', img:'https://images.unsplash.com/photo-1564013799919-ab600027ffc6?w=400&q=70', alt:'New garage door installed on a San Diego-style home'},
    {slug:'garage-door-maintenance-schedule', title:'How Often Should You Service Your Garage Door?', excerpt:'A simple maintenance schedule to keep your garage door running safely for years.', tag:'Maintenance', date:'February 2026', img:'https://images.unsplash.com/photo-1513880989635-6eb491ce7f5b?w=400&q=70', alt:'Technician lubricating garage door spring during maintenance'},
    {slug:'garage-door-materials-comparison', title:'Choosing the Right Garage Door Material', excerpt:'Steel vs. wood vs. aluminum vs. composite: pros, cons, and best uses.', tag:'Installation', date:'January 2026', img:'https://images.unsplash.com/photo-1600585154340-be6161a56a0c?w=400&q=70', alt:'Row of different garage door styles on residential homes'},
    {slug:'electric-gate-pros-cons', title:'Electric Gate vs Manual Gate: Pros and Cons', excerpt:'Deciding between a manual and automatic gate? Here\'s what to consider.', tag:'Gates', date:'January 2026', img:'https://images.unsplash.com/photo-1572120360610-d971b9d7767c?w=400&q=70', alt:'Automatic wrought iron driveway gate on residential property'},
  ];
  const body = `
  ${T.heroInterior('Castle Knowledge Hub', 'Field-tested guides from our technicians to keep your door safe and quiet.', crumbs, prefix)}
  <div class="section"><div class="container">
    <div class="blog-grid">
